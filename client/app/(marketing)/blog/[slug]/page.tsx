...
const fallback: Record<string, BlogPostDTO> = {
  "jamb-2026-biology-topics": {
    ...
    seo_description:
      "Highest-yield JAMB Biology topics and a structured revision plan.",
...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  return buildMetadata({
    title: post.seo_title ?? `${post.title} | YK-Virtual Blog`,
...
export default async function BlogSlugPage(props: Props) {
  ...
  const article = articleJsonLd({
    ...
    url: `https://virtual.ykaycollege.com/blog/${params.slug}`,
  });
