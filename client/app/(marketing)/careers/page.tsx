...
export const metadata: Metadata = buildMetadata({
  title: "Careers — Join the team building YK-Virtual",
  description:
...
const PROCESS = [
  {
    step: "01",
    title: "Apply",
    body: "Write to us with a short note and, for engineering roles, links to work you are proud of.",
  },
  {
    step: "02",
    title: "Intro call",
    body: "A conversation about the role, the team and what you would like to build.",
  },
  {
    step: "03",
    title: "Work sample",
    body: "A focused, take-home exercise or technical conversation — no all-day interviews.",
  },
  {
    step: "04",
    title: "Meet the team & offer",
    body: "Meet the people you would work with, then a clear decision either way.",
  },
];
...
export default function CareersPage() {
  const breadcrumb = breadcrumbJsonLd([
    ...
    { name: "Careers", item: "https://virtual.ykaycollege.com/careers" },
  ]);
      ...
      <div className="container-x py-12">
        ...
        <section className="mt-14 rounded-3xl bg-[#70F250] p-10 text-center md:p-14">
          ...
          <p className="mx-auto mt-4 max-w-2xl leading-relaxed text-black/80">
            We are building a complete virtual school: programmes, cohorts,
            vetted tutors, assessments and progress parents can actually see.
            Every role here shapes that product directly.
          </p>
        </section>
        ...
        <section className="mt-16 rounded-3xl bg-brand-navy p-12 text-center text-white">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm text-white/80">
            Tell us what you would bring to YK-Virtual. We read every
            application.
          </p>
