...
export function generateMetadata(): Metadata {
  return buildMetadata({
    title: "Corporate Training — YKAY | Workforce Upskilling & Digital Academy",
...
export default function CorporatePage() {
  return (
    <main className="container-x py-12">
      ...
      <p className="mt-4 text-lg text-ink-600 max-w-3xl">Tuteria has generic 'Training' but no corporate portal. YKAY treats corporate like an institution with seats, cohorts, skills tracking.</p>
