...
export const metadata: Metadata = buildMetadata({
  title: "British Curriculum Online - Year 7-9, IGCSE & A-Level | YK-Virtual",
  description:
...
const STAGES = [
  {
    title: "Year 7-9",
    desc: "Build strong foundations across English, Maths, Sciences and Computing.",
    subjects: ["Mathematics", "English", "Science", "Computing"],
    photo: "/hero/subjects.jpg",
  },
  {
    title: "IGCSE · Year 10-11",
    desc: "Structured subject cohorts with past-paper practice and coursework support.",
    subjects: ["Computer Science", "Mathematics", "Physics", "English"],
    photo: "/hero/british.jpg",
  },
  {
    title: "A-Level · Year 12-13",
    desc: "Subject-specialist teaching for university-bound learners.",
    subjects: ["Computer Science", "Mathematics", "Further Maths", "Physics"],
...
const HOW = [
  {
    ...
    t: "Termly assessments",
    d: "Aligned to the British curriculum at every stage.",
  },
  {
    icon: <PlayCircle size={18} />,
    t: "Past-paper mocks",
    d: "IGCSE and A-Level practice with full mock exams.",
  },
  {
    icon: <LineChart size={18} />,
    t: "Weekly parent reports",
    d: "Clear visibility into progress every week.",
  },
  {
    icon: <BookOpen size={18} />,
    t: "Recorded lessons",
    d: "Resources and replays after every session.",
  },
];
...
const FAQS = [
  {
    ...
    answer:
      "We prepare learners for Cambridge and Pearson IGCSE and A-Level specifications. Contact us for your specific syllabus.",
  },
  {
    question: "Can my child join mid-year?",
    answer:
      "Yes - we assess the learner's level and place them in the right cohort or a tailored private programme.",
  },
  {
    question: "Do you offer IGCSE exam preparation?",
    answer:
      "Yes. IGCSE cohorts include revision sessions, past-paper practice and mock examinations.",
  },
];
...
export default function BritishCurriculumPage() {
  const breadcrumb = breadcrumbJsonLd([
    { name: "Home", item: "https://virtual.ykaycollege.com/" },
    {
      ...
      item: "https://virtual.ykaycollege.com/curricula/british",
    },
  ]);
  const course = courseJsonLd({
    name: "British Curriculum Online",
    description:
      "Year 7-9, IGCSE and A-Level learning with vetted tutors, structured cohorts and exam preparation.",
    provider: "YK-Virtual",
    url: "https://virtual.ykaycollege.com/curricula/british",
  });
  ...
  return (
    <main>
      ...
      >
        ...
        <Link href="/private-tuition" className="btn-gold">
