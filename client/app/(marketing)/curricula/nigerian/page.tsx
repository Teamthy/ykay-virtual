...
export const metadata: Metadata = buildMetadata({
  title:
    "Nigerian Curriculum Online - JSS1-3, SSS1-3, WAEC, NECO, JAMB | YK-Virtual",
  description:
...
const STAGES = [
  {
    title: "JSS1 - JSS3",
    desc: "Junior secondary foundations in Mathematics, English, Basic Science and more.",
    subjects: ["Mathematics", "English", "Basic Science", "Computer Studies"],
    photo: "/hero/nigerian.jpg",
  },
  {
    title: "SSS1 - SSS3",
    desc: "Senior secondary pathways with subject specialisation and exam focus.",
    subjects: ["Mathematics", "English", "Physics", "Biology", "Economics"],
    photo: "/hero/exam-prep.jpg",
  },
  {
    title: "WAEC · NECO · JAMB",
    desc: "Focused exam preparation: past questions, mocks and revision plans.",
...
const EXAMS = [
  {
    title: "WAEC",
    desc: "Core and elective subjects with past-question practice.",
  },
  { title: "NECO", desc: "Aligned preparation across the shared syllabus." },
  {
    title: "JAMB / UTME",
    desc: "Past-paper patterns, topic focus and timed CBT-style mocks.",
  },
];

const FAQS = [
  {
    question: "Can I prepare for WAEC and NECO at the same time?",
    answer:
      "Yes - the syllabuses overlap heavily. Our tutors align lesson plans to both examinations.",
  },
  {
    question: "Is JAMB preparation separate from school lessons?",
    answer:
      "JAMB/UTME prep runs as a focused programme (cohort or private) with past-question analysis and CBT mocks.",
  },
  {
    question: "Do you cover the new Nigerian curriculum?",
    answer:
      "We follow the current national curriculum framework (NERDC) across JSS and SSS.",
  },
];
...
export default function NigerianCurriculumPage() {
  const breadcrumb = breadcrumbJsonLd([
    { name: "Home", item: "https://virtual.ykaycollege.com/" },
    {
      ...
      item: "https://virtual.ykaycollege.com/curricula/nigerian",
    },
  ]);
  const course = courseJsonLd({
    name: "Nigerian Curriculum Online",
    description:
      "JSS1-3 and SSS1-3 learning with WAEC, NECO and JAMB preparation from vetted subject specialists.",
    provider: "YK-Virtual",
    url: "https://virtual.ykaycollege.com/curricula/nigerian",
  });
  ...
  return (
    <main>
      ...
      <PageHero
        ...
        align="center"
      >
        <Link href="/exam-prep" className="btn-gold">
          Exam preparation
        </Link>
        <Link
