      ...
      <div className="container-x pb-4">
        <section className="mt-10 rounded-2xl border border-ink-100 bg-surface-muted px-6 py-8 md:px-10">
          <div className="grid items-start gap-8 md:grid-cols-[1fr_1fr]">
            <div>
              <h2 className="font-display text-2xl tracking-wide text-brand-navy">
              ...
              <a
                href="#courses"
                className="mt-5 inline-flex items-center gap-2 rounded-full bg-deep px-5 py-2.5 text-sm font-bold text-white hover:bg-deep-light"
              >
            ...
            <ul className="space-y-3 text-sm text-ink-700">
              <li className="flex items-start gap-3">
                <span className="mt-0.5 grid size-6 shrink-0 place-items-center rounded-full bg-primary text-xs font-bold text-ink-900">
                  ✓
                </span>
      ...
      <div className="container-x pb-20 pt-8" id="courses">
        <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-1 font-display text-3xl text-brand-navy">
