...
const EXAMS = [
  {
    ...
    desc: "Year 10-11 revision cohorts with past-paper practice and mocks.",
  ...
  },
  {
    ...
    desc: "Core and elective subjects, aligned lesson plans and practice.",
  ...
  },
  {
    ...
    desc: "Shared-syllabus preparation alongside WAEC where applicable.",
    href: "/curricula/nigerian",
  ...
  },
  {
    code: "JAMB",
    name: "UTME / Post-UTME",
    desc: "Topic-focused revision, question analysis and CBT mock tests.",
    href: "/utme-2026",
    photo: "/hero/utme.jpg",
  },
  {
    code: "A-Level",
    name: "Advanced Level",
    desc: "Subject-specialist tuition for university-bound learners.",
    href: "/curricula/british",
  ...
  },
  {
    code: "SAT",
    name: "SAT",
    desc: "Digital SAT prep — Reading & Writing and Math sections with timed mocks.",
    href: "/sat",
...
const METHOD = [
  {
    ...
    body: "We test where the learner stands against the exam syllabus before building the plan.",
  },
  {
    step: "2",
    title: "Structured revision",
    body: "Weekly sessions focused on high-yield topics, with past questions mapped to each topic.",
  },
  {
    step: "3",
    title: "Mock examinations",
    body: "Timed mocks under exam conditions, marked with feedback and a predicted-grade view.",
  },
  {
    step: "4",
    title: "Parent reports",
    body: "Weekly progress reports so parents see improvement areas in real time.",
  },
];
...
export default function ExamPrepPage() {
  const breadcrumb = breadcrumbJsonLd([
    { name: "Home", item: "https://virtual.ykaycollege.com/" },
    {
      ...
      item: "https://virtual.ykaycollege.com/exam-prep",
    },
  ]);
  const course = courseJsonLd({
    name: "Exam Preparation at YK-Virtual",
    description:
      "WAEC, NECO, JAMB, IGCSE and A-Level preparation: revision cohorts, mocks and private support.",
    provider: "YK-Virtual",
    ...
    <main>
      ...
      >
        <Link href="/programmes" className="btn-gold">
          Join a revision cohort
        </Link>
        <Link
          href="/private-tuition"
          className="rounded-full border border-white/40 px-7 py-3.5 text-sm font-bold text-white hover:bg-white/10"
        >
          Get private support
        </Link>
      </PageHero>
            ...
            >
              <div>
                ...
                <p className="mt-2 text-sm text-white/80">
                  Tell us the exam and target date - we&apos;ll design the
                  revision plan.
                </p>
              </div>
              <Link
        ...
        steps={[
          {
            ...
            desc: "Choose WAEC, NECO, JAMB, IGCSE, A-Level or an entrance exam - we cover every major syllabus.",
          },
          {
            n: "2",
            title: "Join your revision cohort",
            desc: "Match with a vetted subject specialist and a small-group cohort that fits your schedule.",
          },
          {
            n: "3",
            title: "Pass with past papers",
            desc: "Work through past-paper practice, mocks and weekly progress checks until exam day.",
          },
        ]}
      />
      <SuccessChampions />
