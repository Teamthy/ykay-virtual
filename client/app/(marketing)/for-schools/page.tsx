...
export function generateMetadata(): Metadata {
  return buildMetadata({
    title: "For Schools - YK-Virtual B2B | Institutional Accounts",
    description:
      "Partner your school with YK-Virtual: managed tutor network, cohort scheduling, institutional dashboards, pooled billing, safeguarding. Tuteria lacks true B2B infra - YK-Virtual builds it.",
    path: "/for-schools",
  });
}
...
export default function ForSchoolsPage() {
  const breadcrumb = breadcrumbJsonLd([
    ...
    {
      name: "For Schools",
      item: "https://virtual.ykaycollege.com/for-schools",
    },
  ]);
  return (
    <main>
      ...
      <div className="container-x py-12">
        ...
        <section className="mt-12 rounded-2xl bg-brand-blue text-white p-8">
          ...
          <ul className="mt-4 list-disc pl-5 space-y-2 text-white/90">
            <li>
              institutions table + institution_memberships +
              institution_students
            </li>
            <li>
              Object-level authz: institution admin sees only own students
            </li>
        ...
        <section className="mt-14 max-w-xl mx-auto">
          <B2BLeadForm
            defaultType="SCHOOL"
            ctaLabel="Request a school account"
          />
        </section>
      </div>
    </main>
