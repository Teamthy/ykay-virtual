    ...
    <main className="bg-surface pb-20">
      ...
      <div className="mx-auto mt-12 grid max-w-[1400px] gap-6 px-6 sm:grid-cols-2 md:px-10 lg:grid-cols-4 lg:items-center">
        {PLANS.map((p) => (
          <div
            ...
            className={
              p.popular
                ? "flex flex-col rounded-xl border-2 border-brand-gold bg-white p-8 text-center shadow-xl"
                : "flex flex-col rounded-xl border border-ink-200 bg-white p-8 text-center"
            }
          >
            {p.popular && (
              <p className="mb-3">
          ...
          <table className="w-full">
            <thead className="border-b border-ink-200 bg-white">
              <tr>
                ...
                {PLANS.map((p) => (
                  <th key={p.name} className="w-1/4 px-6 py-4 text-center text-lg font-medium text-ink-900">
                    {p.name}
                  </th>
                ))}
              </tr>
      ...
      <div className="mx-auto mt-14 max-w-[1400px] px-6 md:px-10">
        <p className="text-xs text-ink-400">
          Pricing shown is indicative guidance and may vary by tutor experience, subject and level. The final
          quote is always agreed before payment. Institutional pricing for schools and companies is available
          via the <Link href="/for-schools" className="font-semibold text-brand-gold-dark">for schools</Link> and{" "}
          <Link href="/corporate-training" className="font-semibold text-brand-gold-dark">corporate training</Link> pages.
        </p>

        <section className="mt-10 rounded-xl border border-ink-200 bg-white p-8">
