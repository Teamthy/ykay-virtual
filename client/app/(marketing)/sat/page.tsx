...
export const metadata: Metadata = buildMetadata({
  title: "SAT Prep - Target 1400+ | YK-Virtual",
  description:
...
const FAQS = [
  {
    question: "How long does SAT prep take?",
    answer:
      "Most students prepare 8-16 weeks with 2-3 sessions per week, depending on their diagnostic and target score.",
  },
  {
    question: "Is the digital SAT covered?",
    answer:
      "Yes - we train on the current Digital SAT format with Bluebook-style practice tests.",
  },
  {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            courseJsonLd({
              name: "YK-Virtual SAT Preparation",
              description:
                "Digital SAT prep with vetted tutors - diagnostics, section drills and full practice tests.",
              provider: "YK-Virtual",
              url: "https://virtual.ykaycollege.com/sat",
            }),
          ),
        }}
      />
