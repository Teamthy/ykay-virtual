    ...
    <main className="bg-[#FFF7E4]">
      ...
      <section className="relative overflow-hidden bg-primary-light/40">
        <div
          ...
          style={{
            backgroundImage:
              'linear-gradient(165deg, rgba(1,57,32,0.6), rgba(1,57,32,0.2)), url("/hero/utme.jpg")',
          }}
          aria-hidden="true"
        />
          ...
          <div className="mx-auto max-w-[1400px] px-6 py-10 sm:px-6 md:px-10 lg:py-14">
              ...
              <div>
                ...
                <div className="mt-4 max-w-2xl md:mb-8">
                  ...
                  <p className="text-lg text-ink-700">
                    Get Into Your Dream School with Nigeria&apos;s Most Advanced
                    UTME Prep that{" "}
                    <span className="font-bold text-[#4CCB31]">
                      helps you sit the exam prepared
                    </span>
                    .
                  </p>
                </div>
                ...
                <blockquote className="relative hidden max-w-sm md:block">
                  <svg
                    className="absolute -left-6 -top-8 size-16 text-[#013920]/10"
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                    fill="currentColor"
                  ...
                  <div className="relative z-10">
                    <p className="text-xl italic text-[#013920]">
                      &ldquo;Preparing for UTME a second time was tough
                      emotionally. The structured prep, daily practice, and
                      constant support helped me believe in myself - I
                      didn&apos;t just pass, I soared.&rdquo;
                    </p>
                  </div>
                  <footer className="mt-3 flex items-center gap-x-4">
                    ...
                    <div>
                      <div className="font-semibold text-[#013920]">
                        Omoloja Olumuyiwa Eghosa
                      </div>
                      <div className="text-xs text-ink-500">
                        Parent note - attributed story, not a published average
                      </div>
                    </div>
                  </footer>
                </blockquote>
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2 sm:gap-x-10">
              {[
                ...
                <span
                  key={c}
                  className="py-2 text-sm font-semibold text-ink-400"
                >
                  {c}
                </span>
              ))}
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-[1400px] px-6 md:px-10">
          ...
          <p className="mt-2 max-w-2xl text-ink-600">
            One login. Open this site on mobile for live class, recordings and
            reports - not a separate prep domain.
          </p>
          <ul className="mt-8 grid gap-4 md:grid-cols-2">
            {[
              ...
              <li
                key={f}
                className="flex gap-3 rounded-2xl border border-ink-100 bg-surface-muted p-5 text-sm text-ink-700"
              >
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-10 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-4 leading-relaxed text-white/80">
              Tutors plan from{" "}
              <b className="text-[#4CCB31]">past-paper patterns</b> - we do not
              claim a secret 15-year AI score or a predicted paper.
            </p>
            <p className="mt-3 leading-relaxed text-white/80">
              Live class, recordings and timed mocks. We do not guarantee 280+
              or a university offer.
            </p>
          ...
          <div className="space-y-4">
            {INCLUDED.map((i) => (
              ...
              >
                <span className="grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-[#4CCB31] text-[#013920]">
                  {i.icon}
                </span>
                <div>
      ...
      <section className="py-16">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10 grid lg:grid-cols-[0.8fr_1.2fr] gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full bg-[#FFF8E6] px-4 py-1.5 text-xs font-bold text-[#7A5C00]">
            ...
            <p className="mt-3 text-ink-600">
              Every student in the programme competes for scholarships and
              weekly prizes.
            </p>
          </div>
          <ul className="space-y-3">
            {PRIZES.map((p) => (
              ...
              >
                <span className="grid h-10 w-10 shrink-0 place-items-center rounded-full bg-[#4CCB31] font-display text-lg text-[#013920]">
                  {p.n}
                </span>
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-3 flex justify-center gap-4 text-sm font-bold">
              <Link
                ...
                className="text-[#4CCB31] hover:underline"
              >
                Pricing details →
              </Link>
              <Link
                href="/utme-2026/faq"
                className="text-ink-600 hover:text-[#013920] hover:underline"
              >
                FAQ
              </Link>
            </div>
            ...
            {PACKAGES.map((p) => (
              <div
                ...
                className={
                  ...
                  " w-[360px] shrink-0 snap-start"
                }
              >
                {p.featured && (
                  <span className="absolute -top-3 right-6 rounded-full bg-[#4CCB31] px-4 py-1 text-[11px] font-bold uppercase tracking-wide text-[#013920]">
                    Most popular
                  </span>
                )}
                <h3 className="font-display text-2xl tracking-[0.02em] text-[#013920]">
                  {p.name}
                </h3>
                <p className="mt-1 text-xs font-bold uppercase tracking-wide text-[#4CCB31]">
                  {p.tag}
                </p>
                <div className="mt-4 flex items-baseline gap-3">
                  <span className="font-display text-4xl tracking-[0.02em] text-[#013920]">
                    {p.price}
                  </span>
                ...
                <p className="mt-1 text-xs text-ink-500">
                  Comprehensive online UTME Prep for exam success
                </p>
                <ul className="mt-6 space-y-2.5">
                  {p.features.map((f) => (
                    ...
                    >
                      <Check
                        size={15}
                        className="mt-0.5 shrink-0 text-[#009A49]"
                      />{" "}
                      {f}
                    </li>
                  ))}
