...
export default function Utme2026Page() {
  ...
  return (
    <main className="bg-[#FFF8F2]">
      ...
      <section className="relative bg-gradient-to-bl from-[#F3E8FF] via-transparent to-[#FFF8F2]">
        <div className="mx-auto max-w-[1400px] px-6 py-10 sm:px-6 md:px-10 lg:py-14">
          <div className="grid items-center gap-8 md:grid-cols-2 lg:gap-12">
            <div>
              <p className="inline-block bg-clip-text bg-gradient-to-l from-[#0A033C] to-[#FF6636] text-sm font-semibold uppercase tracking-[0.14em] text-transparent">
                Online Prep · Jan – Apr 2026
              </p>

              <div className="mt-4 max-w-2xl md:mb-8">
                <h1 className="mb-4 font-display text-4xl leading-tight tracking-[0.02em] text-[#0A033C] lg:text-6xl">
                  JAMB 2026 SUCCESS
                </h1>
              ...
              <blockquote className="relative hidden max-w-sm md:block">
                <svg className="absolute -left-6 -top-8 size-16 text-[#0A033C]/10" width="16" height="16" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
                ...
                <div className="relative z-10">
                  <p className="text-xl italic text-[#0A033C]">
                ...
                <footer className="mt-3 flex items-center gap-x-4">
                  <div className="shrink-0 grid h-8 w-8 place-items-center rounded-full bg-gradient-to-br from-[#0A033C] to-[#7C3AED] font-display text-white text-sm">
                    O
                  </div>
                  <div>
                    <div className="font-semibold text-[#0A033C]">Omoloja Olumuyiwa Eghosa</div>
          ...
          {/* Clients strip */}
          <div className="mt-10 flex flex-wrap items-center gap-x-1.5 py-3 text-sm text-[#0A033C] after:flex-1 after:border-t after:border-ink-200 after:ms-6 md:mt-14">
