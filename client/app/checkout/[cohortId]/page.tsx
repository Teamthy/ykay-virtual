...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  return buildMetadata({
    ...
    description:
      "Pay securely. Funds are held in escrow until lessons are delivered.",
...
export default async function CheckoutPage(props: Props) {
  ...
  const breadcrumb = breadcrumbJsonLd([
    ...
    { name: "Programmes", item: "https://virtual.ykaycollege.com/programmes" },
    {
      name: cohort.title,
      item: `https://virtual.ykaycollege.com/checkout/${cohort.id}`,
    },
  ]);
