...
export const metadata: Metadata = buildMetadata({
  title: "Download the YK-Virtual Android App",
  description:
    "Download the YK-Virtual Android app (APK) for learning on the go — tutors, live cohorts, quizzes and AI chat. Direct install, no store needed. Updates arrive automatically.",
  path: "/download",
});
    ...
    <main className="relative min-h-screen bg-[#FFF7E4] pb-16 dark:bg-[#0B1220]">
      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        ...
        <div className="rounded-2xl border border-ink-100 bg-white p-8 text-center shadow-sm dark:border-ink-700 dark:bg-[#141C2E]">
          ...
          <h2 className="mt-4 text-xl font-extrabold text-brand-navy dark:text-white">
            YK-Virtual for Android
          </h2>
          ...
          <p className="mx-auto mt-4 max-w-md text-xs leading-5 text-ink-400">
            ...
            <span className="font-semibold">“Install unknown apps”</span> for
        ...
        <div className="mt-6 flex items-start gap-3 rounded-2xl border border-ink-100 bg-white p-5 dark:border-ink-700 dark:bg-[#141C2E]">
          ...
          <div>
            ...
            <p className="mt-1 text-xs leading-5 text-ink-500">
              ...
              background — you never have to re-download it. Every time we ship
              a new feature or fix, you get it on your next open.
            </p>
          </div>
        </div>
