  ...
  return (
    <main className="px-4 py-8 md:px-8">
      ...
      <PageHeader
        ...
        actions={
          <Link href="/become-tutor/apply" className="rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-ink-900 hover:bg-primary-hover">
            Tutor application
          </Link>
        }
      />
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-6 grid grid-cols-2 gap-4 lg:grid-cols-3">
          <div className="rounded-2xl border border-ink-100 bg-white p-5 shadow-sm">
            <p className="text-3xl font-extrabold text-deep">{groups.length}</p>
            <p className="mt-1 text-sm font-semibold text-ink-700">Cohorts I teach</p>
          </div>
          <div className="rounded-2xl border border-ink-100 bg-white p-5 shadow-sm">
            <p className="text-3xl font-extrabold text-deep">{lessons.data?.length ?? "-"}</p>
            <p className="mt-1 text-sm font-semibold text-ink-700">Upcoming lessons</p>
          </div>
          <div className="rounded-2xl border border-ink-100 bg-white p-5 shadow-sm">
            <p className="text-3xl font-extrabold text-deep">{pendingGrading.data ?? "-"}</p>
        ...
        <section className="mt-8">
          <h2 className="font-display text-lg font-bold tracking-[0.02em] text-deep">My cohorts</h2>
          {lessons.isLoading ? (
            ...
            <div className="mt-3 rounded-2xl border border-dashed border-ink-200 bg-white p-10 text-center">
              ...
              <Link href="/become-tutor/apply" className="mt-4 inline-flex rounded-lg bg-primary px-5 py-2.5 text-sm font-semibold text-ink-900 hover:bg-primary-hover">
                Apply as a tutor
              </Link>
            </div>
          ) : (
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <h3 className="font-bold text-deep group-hover:text-primary-dark">{meta.title}</h3>
        ...
        <section className="mt-8 rounded-2xl border border-ink-100 bg-white p-5 shadow-sm">
          <div className="flex items-center justify-between">
            <h2 className="font-display text-lg font-bold tracking-[0.02em] text-deep">Earnings & payouts</h2>
          ...
          <div className="mt-4 grid grid-cols-3 gap-3">
            <div className="rounded-xl bg-surface-muted p-4">
              <p className="text-2xl font-extrabold text-deep">
