...
export function PageHeader({
  ...
  return (
    <section
      className="relative overflow-hidden rounded-3xl bg-[#0F2A1A] bg-cover bg-center px-6 py-7 shadow-card md:px-8 md:py-8"
      style={{
        backgroundImage: `linear-gradient(180deg, rgba(15,42,26,0.62) 0%, rgba(15,42,26,0.82) 100%), url("${cover}")`,
      }}
    >
      <div className="relative">
        <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#D6FF57]">{eyebrow}</p>
