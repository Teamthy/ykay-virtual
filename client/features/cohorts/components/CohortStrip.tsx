  ...
  return (
    <section className="mt-14">
      <div className="flex items-end justify-between flex-wrap gap-3">
        ...
        <Link href="/cohorts" className="text-sm font-semibold text-[#0F2A1A] hover:underline">All cohorts →</Link>
      </div>
          ...
          return (
            <div key={c.id} className="border rounded-2xl p-5">
              ...
              <div className="mt-3 flex items-center justify-between">
                ...
                <span className="font-extrabold text-[#0F2A1A] text-sm">{c.currency} {c.fee.toLocaleString()}</span>
              </div>
