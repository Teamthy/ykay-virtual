...
export const DIGITAL_COURSES: DigitalCourse[] = [
  {
    ...
    modules: [
      ...
      {
        title: "Networks & security basics",
        topics: [
    ...
    faq: [
      {
        q: "Which syllabus does this cover?",
        a: "Both Cambridge IGCSE (0478) and the Nigerian SSS1–3 computer studies curriculum, so learners can sit either exam.",
      },
      {
        q: "Do I need a laptop?",
        a: "Yes — any laptop that runs a browser is fine. All tools used in class are free and cloud-based.",
      },
      {
        q: "Can adults join?",
        a: "Adult learners are welcome in the evening cohorts; the content is the same, paced for older students.",
      },
    ],
  },
  {
    ...
    tagline:
      "Practical computing skills for school, university and the workplace",
    description:
    ...
    modules: [
      {
        ...
        topics: ["Parts of a computer", "Operating systems", "Files & folders"],
      },
      {
      ...
      {
        title: "Capstone",
        topics: ["Mini project", "Showcase", "Certificate of completion"],
      },
    ],
    faq: [
      {
        q: "Is any experience needed?",
        a: "None. This course starts from switching a computer on and builds up step by step.",
      },
      {
        q: "Is there a certificate?",
        a: "Yes — every finisher receives a YK-Virtual certificate of completion.",
      },
    ],
  },
  {
    ...
    modules: [
      {
        title: "Foundations",
        topics: ["Print & input", "Variables & types", "Conditionals"],
      },
      {
        title: "Control flow",
        topics: ["Loops", "Functions", "Debugging like a pro"],
      },
      {
        title: "Data & files",
        topics: ["Lists & dicts", "Reading/writing files", "JSON basics"],
      },
      {
        title: "Final project",
        topics: ["Project clinic", "Code review", "Demo day"],
      },
    ],
    faq: [
      {
        q: "What will I build?",
        a: "Learners typically build a quiz game, a to-do app or a data dashboard — we guide each student to a project they care about.",
      },
      {
        q: "Is this enough to start the AI track?",
        a: "Yes — finishing Python Programming is the recommended path into the AI & Machine Learning course.",
      },
    ],
  },
  {
    ...
    modules: [
      ...
      },
      {
        ...
        topics: [
          "Prompt craft",
          "AI for study & revision",
          "Fact-checking outputs",
        ],
      },
      {
        title: "Building with AI",
        topics: ["No-code AI tools", "APIs in Python", "Mini-app clinic"],
      },
      {
        title: "Ethics & capstone",
        topics: ["Bias & safety", "Team project", "Mentor showcase"],
      },
    ],
    faq: [
      {
        q: "Do I need Python first?",
        a: "Basic Python helps (our Python course is the ideal lead-in), but the build track uses beginner-friendly tools.",
      },
      {
        q: "Is this just ChatGPT lessons?",
        a: "No — you'll learn how AI actually works, then build projects with a mix of cloud APIs and no-code tools.",
      },
    ],
  },
  {
    ...
    tagline:
      "Protect yourself and others online — from passwords to penetration thinking",
    description:
    ...
    modules: [
      ...
      {
        title: "Privacy & data",
        topics: ["What apps know", "Privacy settings", "Digital footprint"],
      },
      {
        title: "Security fundamentals",
        topics: ["Network basics", "Encryption intuition", "Updates & backups"],
      },
      {
        title: "Attacker mindset",
        topics: ["Ethical hacking intro", "Guided labs", "Defence project"],
      },
    ],
    faq: [
      {
        q: "Is hacking taught?",
        a: "Only the defensive mindset — all labs are guided, legal and sandboxed. Nothing we teach is used against real systems.",
      },
      {
        q: "Is there a certification?",
        a: "The course prepares learners toward entry-level security certifications; finishers receive a YK-Virtual certificate.",
      },
    ],
  },
  {
    ...
    modules: [
      ...
      {
        title: "Excel",
        topics: ["Formulas & functions", "Charts", "PivotTables intro"],
      },
      {
        title: "PowerPoint",
        topics: ["Structure & story", "Design principles", "Presenting live"],
      },
      {
        title: "Certification prep",
        topics: ["Exam drill", "Timed practice", "Mock assessment"],
      },
    ],
    faq: [
      {
        q: "Which versions are taught?",
        a: "Microsoft 365 (the cloud version) — the skills transfer to any recent Office version and to Google Workspace.",
      },
      {
        q: "Is the certification exam included?",
        a: "Prep is included; the exam itself is booked separately through Microsoft's testing partner.",
      },
    ],
  },
];
