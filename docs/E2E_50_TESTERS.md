# Can 50 people test YK-Virtual end-to-end?

**Short answer: yes for signup, login, Google, dashboards, browse, and
checkout in Paystack _test_ mode** — if Render stays up and SMTP/Google
are configured. **No** for 50 simultaneous _live_ card charges, SMS OTP,
or load-test proof.
