# NUVORA Mobile — Design Audit (panel review)
...
| UX clarity | **8.5** | Every major screen family has a defined loading / empty / error / success state; wizard drafts persist; signed-out states explain *why* and offer a CTA. |
