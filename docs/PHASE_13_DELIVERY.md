# PHASE 13 — NUVORA Design Rollout II: Typography, Hero & Admin Console — DELIVERY

Branch: `feature/phase-13-nuvora-rollout`
Base: `main` @ `d5380f6` (phase 12 — NUVORA brand + design system)
...
- Lead slide now opens with the brand line: **"Learning beyond boundaries"**
  with the full positioning strip as its tag: *British & Nigerian Curricula ·
  Exam Prep · Private Tuition · Live Cohorts*.
- Palette moved from legacy blue/green to the NUVORA system:
  deep navy `#0A1F44` and digital blue `#1E5EFF` alternating, with the
  NUVORA Plus premium slide on `#060F26` (deep navy-dark).
