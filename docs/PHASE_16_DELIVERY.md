# PHASE 16 — NUVORA "Tuteria-grade" Marketing UX — DELIVERY

Branch: `feature/phase-16-nuvora-tuteria-ux`
...
reference brand blue `#0048D8` ≈ NUVORA digital blue `#1E5EFF`, so NUVORA's
...
Abroad · NUVORA Plus · Languages) applied to `/private-tuition` and
...
· ✉️ hello@nuvora.com (gold CTA), on navy-dark, above the link columns.
