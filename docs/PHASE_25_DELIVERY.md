...
gold border)** · YK-Virtual Plus ₦52,500 · Schools & Corporate Custom) with
...
- `BrandEmail` shell → **gold `#F4B400` header bar with dark YK-Virtual wordmark**,
...
- Order numbers already `YK-Virtual-YYYYMMDD-XXXXXXXX` (migration 000017) —
