# NUVORA — Production Remediation & Launch Plan
**Prepared:** 14 August 2026
**Decisions confirmed:** Public brand = **NUVORA** · persistent demo accounts = **none** · approach = plan before implementation.
...
## G0.1 Standardize public brand on NUVORA
...
- Home page, emails, PWA manifest, mobile display name, policies and deployment guide consistently say NUVORA.
...
|---|---|---|
| 1 | G0: NUVORA sweep, remove demo persistence, fixture factory design | production data contains no demo identity; brand inventory approved |
