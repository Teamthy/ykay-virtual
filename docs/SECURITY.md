...
- Cookie `Domain` must be your custom domain (e.g. `nuvora.com`). Never `.vercel.app` (public suffix).

## Reporting
Email security@nuvora.com (or the ops owner) for vulnerabilities.
