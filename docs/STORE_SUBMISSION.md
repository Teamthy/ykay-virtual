# YK-Virtual — App Store & Play Store Submission Kit (M5)
...
Download YK-Virtual today and learn beyond boundaries.
```
...
deletion (https://app.virtual.ykaycollege.com/privacy).
...
- [ ] Privacy + Terms URLs live (https://app.virtual.ykaycollege.com/privacy, /terms)
