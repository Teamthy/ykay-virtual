    ...
    try {
      ...
      setMessages((m) => [
        ...m,
        {
          id: `e-${Date.now()}`,
          role: "system",
          content: "Could not reach the assistant — try again.",
        },
      ]);
    } finally {
      setBusy(false);
    ...
    >
      <View style={styles.header}>
        ...
        <View style={{ flex: 1, marginLeft: 12 }}>
          <AppText variant="h3">Chat with YK-Virtual</AppText>
          <AppText
            variant="caption"
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            ...
            >
              "What's my next lesson?" · "Explain simultaneous equations" ·
              "Help me revise for UTME"
            </AppText>
          </View>
        }
        renderItem={({ item }) =>
          item.role === "system" ? (
            ...
            >
              <AppText
                variant="body"
                style={item.role === "user" ? styles.textUser : styles.textBot}
              >
                {item.content}
              </AppText>
            </View>
