...
export default function Onboarding() {
  ...
  const createAccount = async () => {
    if (!name.trim() || !email.includes("@"))
      return Alert.alert("Almost there", "Enter your name and a valid email.");
    setBusy(true);
    try {
  ...
  const verify = async () => {
    ...
    try {
      const res = await apiFetch<{ token: string }>(
        "/auth/login-code/mobile/confirm",
        {
          method: "POST",
  ...
  return (
    <Screen scroll>
      ...
      >
        ...
        <AppText
          variant="caption"
          style={[styles.step, { color: colors.greenDark }]}
        >
          Step {step} of 4
        </AppText>
              ...
              return (
                <View
                  ...
                  style={[
                    styles.roleCard,
                    {
                      borderColor: active ? colors.greenDark : colors.border,
                  ...
                  >
                    ...
                    >
                      <Ionicons
                        name={r.icon}
                        size={20}
                        color={active ? colors.greenDark : colors.ink[600]}
                      />
                    </View>
                    ...
                    <Ionicons
                      ...
                      size={20}
                      color={active ? colors.green : colors.ink[200]}
                    />
                  </Pressable>
                </View>
              );
        ...
        {step === 4 && (
          <View style={styles.form}>
            <View
              style={[styles.successIcon, { backgroundColor: colors.green }]}
            >
              <Ionicons name="checkmark" size={40} color={colors.ink[950]} />
            </View>
            <AppText variant="bodySm" style={styles.hint}>
              {name.split(" ")[0]}, your account is ready. Explore programmes,
              cohorts and tutors.
            </AppText>
            <Button
