    ...
    <Screen scroll>
      ...
      {PLANS.map((p) => (
        <Card
          ...
          style={
            p.popular
              ? { ...styles.plan, borderWidth: 2, borderColor: colors.gold }
              : styles.plan
          }
        >
          {p.popular && (
            <View style={styles.popularPill}>
              <AppText
                variant="caption"
                style={{ color: colors.ink[900], fontWeight: "800" }}
              >
                MOST POPULAR
              </AppText>
            </View>
      ...
      <View style={{ marginTop: 16 }}>
        <Button
          label="See full pricing & compare"
          variant="secondary"
          full
          onPress={() =>
            void Linking.openURL("https://virtual.ykaycollege.com/pricing")
          }
        />
      </View>
      ...
      <AppText
        variant="caption"
        style={{ color: colors.ink[400], textAlign: "center", marginTop: 16 }}
      >
        Prices shown are the published web prices and may change — always
        confirm on virtual.ykaycollege.com/pricing.
      </AppText>
    </Screen>
  );
}
