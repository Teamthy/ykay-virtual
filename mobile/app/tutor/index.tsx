  ...
  return (
    <Screen scroll>
      ...
      <View style={styles.statRow}>
        {[
          { label: "Held", value: earnings?.held_total, color: colors.warning },
          { label: "Released", value: earnings?.released_total, color: colors.navy },
          { label: "Paid out", value: earnings?.paid_total, color: colors.success },
        ].map((s) => (
